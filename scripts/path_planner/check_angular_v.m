...
for ii = 0.05:0.05:1.1
    if(ii == 1)
        filename_cmd_vel = ['csvFiles\0.5_1.0.back_cmd_vel.csv'];
        filename_imu = ['csvFiles\0.5_1.0.imu.csv'];
    else
        filename_cmd_vel = ['csvFiles\0.5_' num2str(ii) '.back_cmd_vel.csv'];
        filename_imu = ['csvFiles\0.5_' num2str(ii) '.imu.csv'];
    end
